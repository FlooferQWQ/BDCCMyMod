...
func getBuffs():
	return [
		...
		buff(Buff.PregnantBellySizeModifierBuff, [10.0])
...
func getUnriggedParts(_character):
	...
	if turnON == "on":
		return {
			"Anusus":["res://Modules/MoreBDSMstuffModule/Models/Toys/Anal/Plug_3/Plug_L4_anim.tscn"]
		}
		
	else:
		return {
			"Anusus":["res://Modules/MoreBDSMstuffModule/Models/Toys/Anal/Plug_3/Plug_L4.tscn"]
		}
