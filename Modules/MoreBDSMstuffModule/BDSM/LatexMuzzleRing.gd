...
func getUnriggedParts(_character):
	...
	for i in range(0, LeatherHood_check()["head"].keys().size()):
		if LeatherHood_check()["head"].keys()[i].has(curPart):
			...
			output.merge({"blindfold": ["res://Modules/MoreBDSMstuffModule/Models/Muzzle/MuzzleLatexRing/Muzzle_latex_ring_mid.tscn"]},true)
...
func getInventoryImage():
	return "res://Modules/MoreBDSMstuffModule/Models/Muzzle/MuzzleLatexRing/muzzle_latex_ico.png"
...
func LeatherHood_check():
	return {
		"head":{
			...
			:"res://Modules/MoreBDSMstuffModule/Models/Muzzle/MuzzleLatexRing/Muzzle_latex_ring.tscn",
			
			["dragonhead","horseheadbig"]
			:"res://Modules/MoreBDSMstuffModule/Models/Muzzle/MuzzleLatexRing/Muzzle_latex_ring_big.tscn",
			
			["felinehead","fennechead","cathead"]
			:"res://Modules/MoreBDSMstuffModule/Models/Muzzle/MuzzleLatexRing/Muzzle_latex_ring_nor.tscn",
			#"foxhead":
			#"horsehead":
			#"wolfhead":
			#mods?
