...
func getRiggedParts(_character):
	return {"back_point":"res://Modules/MoreBDSMstuffModule/Models/LeatherArmbinder/LeatherArmbinder_point.tscn"}
	
func getUnriggedParts(_character):

	return {
		"back_moreBDSMstuff": ["res://Modules/MoreBDSMstuffModule/Models/LeatherArmbinder/LeatherArmbinder.tscn"],
		
	}
func getChains():
	if(isWornByWearer()):
		if(getWearer().getInventory().hasItemIDEquipped("inmateanklecuffs")) or (getWearer().getInventory().hasItemIDEquipped("leatheranklecuffs")): # or 
...
func getInventoryImage():
	return "res://Modules/MoreBDSMstuffModule/Models/LeatherArmbinder/ico.png"
